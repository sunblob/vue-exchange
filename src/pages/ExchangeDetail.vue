        ...
        <div class="container">
          <div class="columns">
            <div class="column is-9">
              ...
              <div v-if="user" class="user-tile">
                <div class="user-tile-image">
                  <figure v-if="user.avatar" class="image is-64x64">
                    <img class="is-rounded" :src="user.avatar" />
                  </figure>
                </div>
                <div v-if="user.fullName" class="user-tile-author center">
                  <h3 class="user-tile-author-name">by {{ user.fullName }}</h3>
                </div>
              </div>
            </div>
...
<script>
import ExchangeDealModal from '@/components/exchange/ExchangeDealModal.vue';
...
export default {
  ...
  computed: {
    ...
    isExchangeOwner() {
      return this.$store.getters['auth/isExchangeOwner'](this.user.id);
    },
    canMakeDeal() {
  ...
  created() {
    this.$store.dispatch('exchange/getExchangeById', this.$route.params.id);
  },
};
</script>
